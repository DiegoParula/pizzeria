...
public interface OrderRepository extends ListCrudRepository<OrderEntity, Integer> {
    ...
    @Query(value = "SELECT * FROM pizza_order WHERE id_customer = :id", nativeQuery = true) //nativeQuery = true para indicarle que es un SQL nativo, sabra spring data que no tiene q traducirlo si no que ya esxribimos el codigo nativo
